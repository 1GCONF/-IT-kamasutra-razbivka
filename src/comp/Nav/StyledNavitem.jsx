...
const NavItem = styled.li`
  ...
  background:-webkit-linear-gradient(90deg, rgba(190, 10, 25, 0.85) 0%, rgba(100, 0, 0, 0.96) 100%);

  /* opera 11.10+ */
  background:-o-linear-gradient(90deg, rgba(190, 10, 25, 0.85) 0%, rgba(100, 0, 0, 0.96) 100%);

  /* ie 6-9 */
  filter: progid:DXImageTransform.Microsoft.gradient( startColorstr='#640000', endColorstr='#BE0A19', GradientType=0 );

  /* ie 10+ */
  background:-ms-linear-gradient(90deg, rgba(190, 10, 25, 0.85) 0%, rgba(100, 0, 0, 0.96) 100%);

  /* global 94%+ browsers support */
  background:linear-gradient(90deg, rgba(190, 10, 25, 0.85) 0%, rgba(100, 0, 0, 0.96) 100%);
`;
const A = styled.a`
padding: 3ex;
width: 100%;
